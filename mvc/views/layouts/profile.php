                        ...
                        <div class="items">
                            <ul>
                                ...
                                <li class="have-menu">
                                    ...
                                    <ul class="drop-menu">
                                        <li><a href="products/banphim">Bàn Phím Cơ</a></li>
                                        <li><a href="products/manhinh">Màn Hình Gaming</a></li>
                                        <li><a href="products/chuot">Chuột Gaming</a></li>
                                        <li><a href="products/ghe">Ghế Gaming</a></li>
                                    </ul>
                                </li>
                                <li>
                                ...
                                <li class="have-menu">
                                    <a href="products/pcgaming">
                                        <img src="assets/img/svg/pc.svg" alt="img/svg/pc.svg" title="pc" />
                                        <span class="text-item-dropdow">Bộ PC</span>
                                    </a>
                                    <ul class="drop-menu">
                                        <li><a href="products/pcgaming">Gaming</a></li>
                                        <li><a href="products/pcwork">Văn phòng</a></li>

                                    </ul>
                                </li>
                                <li class="have-menu">
                                    <a href="products/laptopgaming">
                                        <img src="assets/img/svg/laptop.svg" alt="img/svg/laptop.svg" title="laptop"
                                            title="laptop" />
                                        <span class="text-item-dropdow">Laptop</span>
                                    </a>
                                    <ul class="drop-menu">
                                        <li><a href="products/laptopgaming">Gaming</a></li>
                                        <li><a href="products/laptopvp">Văn phòng</a></li>
        ...
        <div class="container ">
            <div class="gird">
                <div class="user-activity ">
                    <div class="avatar">
                        <img src="assets/img/profile/avatar-default.png" alt="img/profile/avatar-default.png"
                            title="avatar">
                        <span class="name"><?php echo $_SESSION['user'] ?></span>
                    </div>
                    <div class="menu-activity ">
                        <a href="profile/info"><i class="fas fa-user"></i><span class="menu-activity-text">Thông tin tài
                                khoản</span></a>
                        <a href="#"><i class="far fa-list-alt"></i><span class="menu-activity-text">Đơn hàng của
                                tôi</span></a>
                        <a href="profile/address"><i class="fa-solid fa-location-dot"></i><span
                                class="menu-activity-text">Địa chỉ
                                giao hàng</span></a>
                        <a href="#"><i class="fa fa-archive" aria-hidden="true"></i><span class="menu-activity-text">Sản
                                phẩm mua sau</span></a>
                        <a href="home/sale"><i class="fas fa-fire-flame-curved" style="color: #f78d1c;"></i><span
                                class="menu-activity-text">Tin khuyến mãi</span></a>
                        <a href="#"><i class="fas fa-eye"></i><span class="menu-activity-text">Sản phẩm đã
                                xem</span></a>
                        <a href="profile/editpass"><i class="fas fa-user-lock"></i><span class="menu-activity-text">Đổi
                                mật
                                khẩu</span></a>
                        <a href="home/logout"><i class="fas fa-power-off"></i><span class="menu-activity-text">Đăng
                                Xuất</span></a>
                    </div>
                </div>
