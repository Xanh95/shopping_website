<form action="" id="confirm-pay-cart" novalidate="novalidate" method="post">
                            ...
                            <div class="address-form">
                                ...
                                <div class="form-item">
                                    ...
                                    <span class="input input--isao">
                                        <input class="input__field input__field--isao" type="text" id="input-name-recipient" name="input-name-recipient">
                                        <label class="input__label input__label--isao" for="input-name-recipient" data-content="Người tại địa chỉ nhận">
                                ...
                                <div class="form-item">
                                    ...
                                    <span class="input input--isao">
                                        <input class="input__field input__field--isao" type="text" id="input-phone-recipient" name="input-phone-recipient">
                                        <label class="input__label input__label--isao" for="input-phone-recipient" data-content="Người tại địa chỉ nhận">
                                            <span class="input__label-content input__label-content--isao">Người tại địa
                                                chỉ nhận</span>
                                        </label>
                                    </span>
                                ...
                                <div class="form-item">
                                    ...
                                    <span class="input input--isao">
                                        <input class="input__field input__field--isao" type="text" id="input-city-recipient" name="input-city-recipient">
                                        <label class="input__label input__label--isao" for="input-city-recipient" data-content="Nơi nhận">
                                ...
                                <div class="form-item">
                                    ...
                                    <span class="input input--isao">
                                        <input class="input__field input__field--isao" type="text" id="input-district-recipient" name="input-district-recipient">
                                        <label class="input__label input__label--isao" for="input-district-recipient" data-content="Nơi nhận">
                                            <span class="input__label-content input__label-content--isao">Nơi
                                                nhận</span>
                                        </label>
                                    </span>
                                ...
                                <div class="form-item">
                                    ...
                                    <span class="input input--isao">
                                        <input class="input__field input__field--isao" type="text" id="input-address-recipient" name="input-address-recipient">
                                        <label class="input__label input__label--isao" for="input-address-recipient" data-content="Người nhận">
    ...
    <?php if (isset($_SESSION['user']) && !empty($address)) : ?>
                    ...
                    <table>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td rowspan="4">
                                    <input type="radio" name="ship-address" id="address-<?php echo $value['id'] ?>" value="<?php echo $value['id'] ?>">
                                </td>
                            </tr>
                            <tr>
                                <td>Địa Chỉ</td>
                            ...
                            <tr>
                                <td></td>
                                <td style="color: red">
                                    <i class="fas <?php echo $value['address_type'] == 1 ? "fa-house-user" : "fa-building" ?>"></i>
