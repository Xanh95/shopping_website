                ...
                <div>
                    ...
                    <div class="quantity">
                        ...
                        <div class="quantity-wrap">
                            <input type="text" name="quantity" class="qty-input-2" size="2" id="products_<?php echo $product['id'] ?>_quantity" value="<?php echo isset($_SESSION[$id]) ? $_SESSION[$id] : ''; ?>" />
                            <div class="qty-action">
                                <span title="Thêm" class="add-qty" data-id_product="<?php echo $product['id'] ?>">+</span>
                                <span title="Bớt" class="sub-qty" data-id_product="<?php echo $product['id'] ?>">-</span>
                            </div>
                        </div>
