        ...
        <div class="container ">
            <div class="gird">
                <div class="user-activity ">
                    <div class="avatar">
                        <img src="assets/img/profile/avatar-default.png" alt="img/profile/avatar-default.png" title="avatar">
                    ...
                    <div class="menu-activity ">
                        <a href="profile/info"><i class="fas fa-user"></i><span class="menu-activity-text">Thông tin tài
                                khoản</span></a>
                        <a href="profile/myOder"><i class="far fa-list-alt"></i><span class="menu-activity-text">Đơn
                                hàng của
                                tôi</span></a>
                        <a href="profile/address"><i class="fa-solid fa-location-dot"></i><span class="menu-activity-text">Địa chỉ
                                giao hàng</span></a>
                        <a href="#"><i class="fa fa-archive" aria-hidden="true"></i><span class="menu-activity-text">Sản
                                phẩm mua sau</span></a>
                        <a href="home/sale"><i class="fas fa-fire-flame-curved" style="color: #f78d1c;"></i><span class="menu-activity-text">Tin khuyến mãi</span></a>
                        ...
                        <a href="profile/editpass"><i class="fas fa-user-lock"></i><span class="menu-activity-text">Đổi
                                mật
                                khẩu</span></a>
                        <a href="profile/logout"><i class="fas fa-power-off"></i><span class="menu-activity-text">Đăng
                                Xuất</span></a>
                    </div>
                </div>
